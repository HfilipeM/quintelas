...
export default function HeroSection() {
  ...
  return (
    <section className="snap-start h-screen w-full relative flex items-center justify-center bg-white overflow-hidden">
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#FF6B35]/5 via-transparent to-white" />
      ...
      >
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-light tracking-tighter mb-3 sm:mb-6 text-black"
        >
        ...
        <motion.p
          ...
          className="text-base sm:text-lg md:text-2xl lg:text-3xl font-light text-[#FF6B35] tracking-wide"
        >
          ...
          {slides.map((_, idx) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-300 ${
                idx === currentSlide ? 'bg-[#FF6B35] w-8' : 'bg-gray-300 hover:bg-gray-400'
              }`}
